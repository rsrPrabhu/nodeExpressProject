...
<details>
  ...
  <ol>
    <li>
      <a href="#about-the-project">About nodeExpress Project</a>
      <ul>
...
<!-- ABOUT THE PROJECT -->
## About nodeExpress Project

This is a Node based Express project. This project contains all the functionalities involved to create the APIs. Mongo is the database .

Here's why:
* Wanted  some APIs for all front end application.
* Mongoose is the ORM tool used to connect Database.
...
1. Clone the repo
   ```sh
   https://github.com/rsrPrabhu/nodeExpressProject.git
   ```
